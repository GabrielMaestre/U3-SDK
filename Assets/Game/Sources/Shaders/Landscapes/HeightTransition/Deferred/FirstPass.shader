Shader "Landscapes/HeightTransition/Deferred/FirstPass" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		#pragma surface surf StandardSpecular vertex:SplatmapVert finalcolor:splatmapFinalColor finalprepass:splatmapFinalPrepass finalgbuffer:splatmapFinalGBuffer addshadow fullforwardshadows
		...
		void surf(Input IN, inout SurfaceOutputStandardSpecular OUT)
		{
			...
			OUT.Albedo *= hole;
			clip(((hole == 0.0f) & (_TerrainHighlightHoles < 0.5f)) ? -1 : 1);
#endif // _ALPHATEST_ON
		}
	...
	Dependency "AddPassShader" = "Landscapes/HeightTransition/Deferred/AddPass"
	Dependency "BaseMapShader" = "Landscapes/Base"
