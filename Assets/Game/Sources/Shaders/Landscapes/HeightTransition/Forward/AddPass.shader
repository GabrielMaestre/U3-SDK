Shader "Landscapes/HeightTransition/Forward/AddPass" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		#pragma surface surf StandardSpecular decal:blend vertex:SplatmapVert finalcolor:splatmapFinalColor finalprepass:splatmapFinalPrepass finalgbuffer:splatmapFinalGBuffer fullforwardshadows nometa
